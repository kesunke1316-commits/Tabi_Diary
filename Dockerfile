...
# docker build -t tabi_diary .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name tabi_diary tabi_diary
...
RUN groupadd --system --gid 1000 rails && \
    ...
    mkdir -p /rails/tmp/pids /rails/tmp/cache /rails/tmp/sockets /rails/public/assets && \
